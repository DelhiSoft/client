...
function actions(result){
    ...
    switch(result.action){
        ...
        case "form3":
			...
			var nearby;
			$("#male").click(function (){
console.log("male clicked");				sex="male";
				$("#male").addClass("active");
				$("#female").removeClass("active");
				console.log("function completed successfully");
			});
			$("#female").click(function (){
				console.log("Female clicked");sex="female";$("#female").addClass("active");$("#male").removeClass("active");
				console.log("Function completed successfully");
				});
			$("#privacy_o").click(function (){
				console.log("Privacy o clicked");
				nearby=1;$("#privacy_o").addClass("active");$("#privacy_f").removeClass("active");$("#privacy_n").removeClass("active");
				console.log("function completed successfully");
				});
			...
			name=$("#name").val();
				...
				console.log("line 100 is ok. Data prepared to send is:"+data);
				send_to_server(data);
				console.log("line 102 is also ok. Check the server logs");
			});
